...
func SetupDBCluster(mgr ctrl.Manager, o controller.Options) error {
	...
	// removed connection.NewDetailsManager usage (v2) — external secret stores are handled differently
	...
	reconcilerOpts := []managed.ReconcilerOption{
		...
		// omit managed.WithConnectionPublishers(cps...), handled in v2 differently
	}
